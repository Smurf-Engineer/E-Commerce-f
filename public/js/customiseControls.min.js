  ...
  fabric.util.object.extend(fabric.Object.prototype, {
            ...
            tl: {
              x:
                point === 'bl' || point === 'tl'
                  ? x - this.cornerSize
                  : x + 100,
              y: point === 'bl' || point === 'br' ? y : y - this.cornerSize
            },
            tr: {
              x: point === 'bl' || point === 'tl' ? x : x + this.cornerSize,
              y: point === 'bl' || point === 'br' ? y : y - this.cornerSize
            },
            bl: {
              x: point === 'bl' || point === 'tl' ? x - this.cornerSize : x,
              y: point === 'bl' || point === 'br' ? y + this.cornerSize : y
            },
            br: {
              x: point === 'bl' || point === 'tl' ? x : x + this.cornerSize,
              y: point === 'bl' || point === 'br' ? y + this.cornerSize : y
    ...
    _drawControl: function(
      ...
      var size = this.cornerSize,
        ...
        cornerPadding = this.cornerPadding || 0
