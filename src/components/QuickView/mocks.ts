...
export const ProductData = {
  ...
  productSpecs:
    '<p>INTENDED USE: Competitive, Distance Riders </p><p> TEMPERATURE RANGE: Cool/Warm </p><p> MATERIALS: Coolmax Fabric, Diamond Fabric, Airstream Fabric, YKK Zipper, Flatlock Stitching</p>'
}
