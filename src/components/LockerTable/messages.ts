...
export default defineMessages({
  name: {
    id: 'components.LockerTable.name',
    defaultMessage: 'Name',
  },
  description: {
    id: 'components.LockerTable.description',
  ...
  currencyDesc: {
    ...
    defaultMessage:
      ...
      '<span>BASE CURRENCY</span>The <b>Base Currency</b> is your default store currency based on your region. For Canadian Resellers, the base currency is set to CAD. For Resellers in the USA, the base currency is USD.',
  },
  msrpDesc: {
    id: 'components.LockerTable.msrpDesc',
    defaultMessage:
      // tslint:disable-next-line: max-line-length
      '<span>MSRP</span>The <b>MSRP</b> is Jakroo’s default on-demand store price. This may serve as a benchmark for setting your list price.',
  },
  dealerPrice: {
    id: 'components.LockerTable.dealerPrice',
    defaultMessage:
      // tslint:disable-next-line: max-line-length
      '<span>DEALER PRICE</span>The <b>Dealer Price</b> is the price used to calculate your profit. This price is static and will not change based on quantity sold.',
  },
  listPriceDesc: {
    id: 'components.LockerTable.listPriceDesc',
    defaultMessage:
      // tslint:disable-next-line: max-line-length
      '<span>LIST PRICE</span>The <b>List Price</b> is what your customers will see on the store. The minimum price allowed is the MSRP. You can set a higher price to increase your profit amount.',
  },
})
