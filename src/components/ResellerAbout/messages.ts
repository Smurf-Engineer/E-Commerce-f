...
export default defineMessages({
  ...
  errorTitle: {
    id: 'components.ResellerAbout.errorTitle',
    defaultMessage: 'Oops!'
  },
  errorMessage: {
    id: 'components.ResellerAbout.errorMessage',
    defaultMessage: 'Something went wrong'
  },
  makeAffiliate: {
    id: 'components.ResellerAbout.makeAffiliate',
    defaultMessage: 'Make account a Reseller Account'
  },
  success: {
    id: 'components.ResellerAbout.success',
    defaultMessage: 'Request sent'
  },
  pending: {
    id: 'components.ResellerAbout.pending',
    defaultMessage: 'Waiting for Approval'
  },
  linkedTo: {
    id: 'components.ResellerAbout.linkedTo',
    defaultMessage: 'Linked to: {paypalAccount}'
  },
  successLink: {
    id: 'components.ResellerAbout.successLink',
    defaultMessage: 'Linked successfully!'
  },
  howItWorks: {
    id: 'components.ResellerAbout.howItWorks',
    defaultMessage: 'How it works'
  },
  createDesigns: {
    id: 'components.ResellerAbout.createDesigns',
    defaultMessage: 'Create your own designs or have our Pro Designers create them for you.'
  },
  buildStore: {
    id: 'components.ResellerAbout.buildStore',
    defaultMessage: `Build your custom store and add your products. It's fast and easy!`
  },
  shareStore: {
    id: 'components.ResellerAbout.shareStore',
    defaultMessage: 'Share your store and start selling. We take care of all the details.'
  },
  getPaid: {
    id: 'components.ResellerAbout.getPaid',
    defaultMessage: 'Get Paid! Payouts are deposited directly into your PayPal account.'
  },
  faqTitle: {
    id: 'components.ResellerAbout.faqTitle',
