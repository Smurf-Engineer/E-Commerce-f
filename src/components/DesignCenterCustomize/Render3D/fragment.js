...
void main() {
  ...
  // Mix the textures
  // vec4 mixTextures = texelColor1 + texelColor2
  float mixColorsA = texelColor1.a + texelColor2.a ;
  vec3 mixColors = (texelColor1.rgb * texelColor1.a) + (texelColor2.rgb * (1.0 - texelColor1.a));
