...
export default defineMessages({
  ...
  resellerConcept: {
    ...
    // tslint:disable-next-line:max-line-length
    defaultMessage: `<p>Direct Fulfilment Stores are a fast and convenient option for resellers to sell their custom shop kits to their customers without the hassle of holding inventory.</p><p>Direct Fulfilment store orders are produced on demand upon receipt of order and typically ship direct to the customer within 7-12 days of receipt (excluding Federal holidays). Default reseller margin is set at 20% of the MSRP pricing.</p><p>Share your store with your customers and they can individually checkout using their preferred payment method, designate their own shipping address, and track their orders on their JAKROO account.  JAKROO handles all transaction and customer service costs. Margin is paid out monthly direct to a PayPal account of your choice.</p>`
  }
})
