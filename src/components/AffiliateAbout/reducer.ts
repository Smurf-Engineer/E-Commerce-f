/**
 * AffiliatesAbout Reducer - Created by Jesús Apodaca on 30/06/20.
 */
...
const affiliatesAboutReducer: Reducer<any> = (state = initialState, action) => {
  switch (action.type) {
...
export default affiliatesAboutReducer
