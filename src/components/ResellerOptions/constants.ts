/**
 * ResellerOptions Types - Created by Jesús Apodaca on 25/05/20.
 */
const namespace = 'src/MyAccount/ResellerOptions'
...
export const ON_PAGE_CHANGE = `${namespace}/ON_PAGE_CHANGE`
