/**
 * ResellerPayouts Test - Created by Jesús Apodaca on 29/11/19.
 */
import resellerPayoutsReducer, { initialState } from './reducer'
...
describe('ResellerPayouts Screen', () => {
    describe('Actions', () => {
        it('onResetReducer', () => {
    ...
    describe('Reducer', () => {
        describe('RESET_DATA', () => {
            ...
            it('Should be init with currentPage', () => {
                const selectedKeyState = resellerPayoutsReducer(
                    initialState,
                    resetDataAction()
                )
        ...
        describe('SET_CURRENT_PAGE', () => {
            describe('Set currentPage action', () => {
                ...
                it('Handles custom value in currentPage', () => {
                    const value = 2
                    const currentState = resellerPayoutsReducer(
                        initialState,
