...
export default defineMessages({
  ...
  style: {
    ...
    defaultMessage: 'SELECT A DESIGN'
  },
  styleMessage: {
    id: 'components.DesignCenterInfo.styleMessage',
    defaultMessage:
      // tslint:disable-next-line:max-line-length
      'Select a base design as a starting point for your design. You can also view various levels of design complexity.'
  },
  customize: {
  ...
  customizeMessage: {
    id: 'components.DesignCenterInfo.customizeMessage',
    defaultMessage: ''
  },
  preview: {
    id: 'components.DesignCenterInfo.preview',
