...
function reducedPixels(imageData: ImageData) {
  var i, x, y, row,
...
function detectBlur(pixels: Uint8ClampedArray[]) {
...
function measureBlur(imageData: ImageData) {
...
measureBlur.async = function (imageData: ImageData) {
  if (!worker) {
...
measureBlur.setup = function (configExt: any) {
