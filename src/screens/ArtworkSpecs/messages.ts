...
export default defineMessages({
  ...
  completeText: {
    ...
    <p>Its about a 50-50 gamble. Some PDF files might appear to be Vector art, but in reality are Raster. Your best bet to finding out if your PDF file is vector or raster is to just send it to us at: <span class="highlight">customdesign@jakroousa.com</span></p>
    ...
    <p>If you would like to see JAKROO's Color Chart printed on the fabrics we use for our apparel, please contact us at <span class="highlight">customdesign@jakroousa.com</span> or ask your Account Manager to send you a physical swatch in the mail.</p>
