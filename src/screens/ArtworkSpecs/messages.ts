...
export default defineMessages({
  ...
  completeText: {
    ...
    <p>Its about a 50-50 gamble. Some PDF files might appear to be Vector art, but in reality are Raster. Your best bet to finding out if your PDF file is vector or raster is to just send it to us at: <span class="highlight"><a href="mailto:customdesign@jakroousa.com">customdesign@jakroousa.com</a></span></p>
    ...
    <p>If you would like to see JAKROO's Color Chart printed on the fabrics we use for our apparel, please contact us at <span class="highlight"><a href="mailto:customdesign@jakroousa.com">customdesign@jakroousa.com</a></span> or ask your Account Manager to send you a physical swatch in the mail.</p>
    If you have specific PANTONE® colors that need to be matched, please use the PANTONE® Solid Coated Color Swatch Book to provide us with those colors. Sublimated colors may appear slightly muted when compared to PANTONE® color swatches. Fabric tends to soak up light compared with the reflective nature of glossy paper. <span class="highlight"><a href="https://www.pantone.com/color-finder">Find a PANTONE® Color</a></span> *Before using, understand that the colors shown on this site are computer simulations of the PANTONE® Colors and may not match PANTONE-identified color standards. Always consult PANTONE® Publications to visually evaluate any result before utilization.
    `
  },
  flatLock: {
    id: 'screens.ArtworkSpecs.flatLock',
    defaultMessage: 'FLATLOCK COLORS'
  },
  flatLockText: {
