/**
 * designLabReducer Reducer - Created by cazarez on 27/02/18.
 */
...
const designLabLandingReducer: Reducer<any> = (state = initialState, action) => {
  switch (action.type) {
...
export default designLabLandingReducer
