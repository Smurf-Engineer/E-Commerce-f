...
const peopleArray = [
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/wayne.png',
    name: 'WAYNE DU',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/derek.png',
    name: 'DEREK WISEMAN',
    position: 'COO',
    description:
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/wei.png',
    name: 'WEI TAN',
    position: 'CFO',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/eric.png',
    name: 'ERIC PETERSON',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/patricia.png',
    name: 'PATRICE SPYRKA',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/sherwin.png',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/michael.png',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/joseph.png',
    name: 'JOSEPH SIWA',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/john.png',
    name: 'JOHN BERIAULT',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/emily.png',
    name: 'EMILY MCKEAN',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/alex.png',
    name: 'ALEX CHIU',
    position: 'Account Manager',
    description:
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/ben.png',
  ...
  {
    image: 'https://storage.googleapis.com/jakroo/screens/aboutus/elie.png',
    name: 'ELIE MALMAN',
    position: 'Graphic Designer',
...
export class AboutUsPage extends React.Component<Props, {}> {
  ...
  render() {
    ...
    const MarkComponent = ({ text }: any) => (
      <div>
        <MapMarker
          src={'https://storage.googleapis.com/jakroo/screens/redmarker.png'}
        />
      </div>
    )
    const center = {
    ...
    return (
      <Layout {...{ intl, history }}>
        <Container>
          <ImageTitleContainer>
            <StyledImg
              src={'https://storage.googleapis.com/jakroo/screens/aboutus.jpg'}
            />
            <HeaderTextContainer>
              <Title>
