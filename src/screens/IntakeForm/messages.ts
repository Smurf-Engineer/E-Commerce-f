...
export default defineMessages({
  ...
  successTitle: {
    id: 'screens.IntakeForm.successTitle',
    defaultMessage: 'WE’VE RECEIVED YOUR PRO DESIGN REQUEST'
  },
  successMessage: {
  ...
  colorsBody: {
    id: 'screens.IntakeForm.colorsBody',
    defaultMessage: 'Tips on color selection'
  },
  colorsTipTitle: {
  ...
  reviewBody: {
    ...
    defaultMessage: `Great job! Now please review all details for accuracy prior to submission`
  },
  inspirationTip: {
