...
export default defineMessages({
  ...
  orederInThreeWeeksQuestion: {
    ...
    defaultMessage:
      'I have a customer who needs an order in less than three weeks. Is this possible?'
  },
  orederInThreeWeeksAnswer: {
    id: 'screens.Faq.orederInThreeWeeksAnswer',
    defaultMessage:
      'This depends on how many items you need, provided all the artwork is completed and approved.'
  }
})
