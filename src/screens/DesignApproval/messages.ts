...
export default defineMessages({
  ...
  fileQuestion: {
    id: 'screens.DesignApproval.fileQuestion',
    defaultMessage: 'Do you have a file you would like to include with your notes?'
  },
  required: {
    id: 'screens.DesignApproval.required',
    defaultMessage: 'Reply'
  },
  approvalLog: {
    id: 'screens.DesignApproval.approvalLog',
    defaultMessage: 'Approval Log'
  },
  requestEdit: {
    id: 'screens.DesignApproval.requestEdit',
    defaultMessage: 'REQUEST EDITS'
  },
  enterEditNotes: {
    id: 'screens.DesignApproval.enterEditNotes',
    defaultMessage: 'ENTER EDIT NOTES'
  },
  purchaseMore: {
